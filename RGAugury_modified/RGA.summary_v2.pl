...
print join("\t","NBS","TX","RX","CN","TN","RN","NL","TC","RC","TCN","RCN","CNL","TNL","RNL","TCNL","RCNL","RTCNL","Others","RLP","RLK","TM-CC\n");
#foreach my $type ("NBS","CNL","TNL","RNL","RN","RX","CN","TN","NL","TX","OTHER","RLP","RLK","TM-CC") {
foreach my $type ("NBS","TX","RX","CN","TN","RN","NL","TC","RC","TCN","RCN","CNL","TNL","RNL","TCNL","RCNL","RTCNL","Others","RLP","RLK","TM-CC") {
